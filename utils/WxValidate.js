...
class WxValidate {
  ...
  __initMethods() {
      ...
      that.methods = {
          ...
          /* 验证手机格式*/
          tel(value) {
            return that.optional(value) || /^(13[0-9]|14[0-9]|15[0-9]|16[0-9]|17[0-9]|18[0-9]|19[0-9])\d{8}$$/.test(value)
          },
        /* 验证密码*/
        password(value) {
       ...
       /*验证支付密码 */
        ...
        money(value){
          return that.optional(value) || /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/.test(value)
        },
          /**
           * 验证整数
           */
          ...
          weight(value){
            return that.optional(value) || /^(\d|[1-9]\d|99)(\.\d{1,2})?$/.test(value)
          },
          /**
           * 验证两个输入框的内容是否相同
           */
